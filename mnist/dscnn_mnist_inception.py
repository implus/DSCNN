...
MODEL_FILE = 'model_inception_mnist'
...
def build_model(input_width, input_height, input_dim, output_dim, dep = 0,
    ...
    # inception
    l_inception_1x1 = cuda_convnet.Conv2DCCLayer(
        l_pool1,
        num_filters = 64,
        filter_size = (1, 1),
        nonlinearity = lasagne.nonlinearities.rectify,
    ...
    l_inception_3x3_reduce = cuda_convnet.Conv2DCCLayer(
        l_pool1,
        num_filters = 96,
        filter_size = (1, 1),
        nonlinearity = lasagne.nonlinearities.rectify,
    ...
    l_inception_3x3 = cuda_convnet.Conv2DCCLayer(
        l_inception_3x3_reduce,
        num_filters = 128,
        pad = 1,
        filter_size = (3, 3),
        nonlinearity = lasagne.nonlinearities.rectify,
    ...
    l_inception_5x5_reduce = cuda_convnet.Conv2DCCLayer(
        l_pool1, 
        num_filters = 16,
        filter_size = (1, 1),
        nonlinearity = lasagne.nonlinearities.rectify,
    ...
    l_inception_5x5 = cuda_convnet.Conv2DCCLayer(
        l_inception_5x5_reduce,
        num_filters = 32,
        pad = 2,
        filter_size = (5, 5),
        nonlinearity = lasagne.nonlinearities.rectify,
    ...
    l_concat = lasagne.layers.concat(
        [l_inception_1x1, l_inception_3x3, l_inception_5x5],
        )
