...
MODEL_FILE = 'model_128+64*dc_32*2**dcp_mnist'
...
def gao(depth, num_epochs=NUM_EPOCHS, lamda = LAMDA, lastdep = False):
...
# latest pool layer
    ...
    expre = model.input_layer.get_output(input)
