...
FILE_MODEL = 'model_192c_48*2**dcp_1024_1024'
...
# latest pool layer
    ...
    for i in range(0, X_train.shape[0]):
        ...
        arr = np.concatenate((gray, arr), axis = 2)
    ...
    if data_train.shape[2] == 1:
        ...
        filename = FILE_MODEL + "_" + str(data_train.shape[1]) + "_feature.npz"
